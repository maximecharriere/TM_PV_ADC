...
df_P_ac_L1 = pd.read_csv(PARENT_DATA_DIR+r"\BFH_Tiergarten_Ost_1PVS_1min\measurements\01_02_Tiergarten_Ost_P_ac_L1_2004.csv",
                         skiprows=3, parse_dates=['_start', '_time', '_stop'], nrows=70000)
df_P_ac_L2 = pd.read_csv(PARENT_DATA_DIR+r"\BFH_Tiergarten_Ost_1PVS_1min\measurements\01_02_Tiergarten_Ost_P_ac_L2_2004.csv",
                         skiprows=3, parse_dates=['_start', '_time', '_stop'], nrows=70000)
df_P_ac_L3 = pd.read_csv(PARENT_DATA_DIR+r"\BFH_Tiergarten_Ost_1PVS_1min\measurements\01_02_Tiergarten_Ost_P_ac_L3_2004.csv",
                         skiprows=3, parse_dates=['_start', '_time', '_stop'], nrows=70000)
# df_G_0 = pd.read_csv(PARENT_DATA_DIR+r"\BFH_Tiergarten_Ost_1PVS_1min\measurements\01_02_Tiergarten_Ost_G_0_2004.csv",
#                      skiprows=3, parse_dates=['_start', '_time', '_stop'], nrows=70000)
# df_G_i = pd.read_csv(PARENT_DATA_DIR+r"\BFH_Tiergarten_Ost_1PVS_1min\measurements\01_02_Tiergarten_Ost_G_i_2004.csv",
#                      skiprows=3, parse_dates=['_start', '_time', '_stop'], nrows=70000)
# df_I_dc = pd.read_csv(PARENT_DATA_DIR+r"\BFH_Tiergarten_Ost_1PVS_1min\measurements\01_02_Tiergarten_Ost_I_dc_2004.csv",
#                       skiprows=3, parse_dates=['_start', '_time', '_stop'], nrows=70000)
# df_I_ref = pd.read_csv(PARENT_DATA_DIR+r"\BFH_Tiergarten_Ost_1PVS_1min\measurements\01_02_Tiergarten_Ost_I_ref_2004.csv",
#                        skiprows=3, parse_dates=['_start', '_time', '_stop'], nrows=70000)
# df_T_a = pd.read_csv(PARENT_DATA_DIR+r"\BFH_Tiergarten_Ost_1PVS_1min\measurements\01_02_Tiergarten_Ost_T_a_2004.csv",
#                      skiprows=3, parse_dates=['_start', '_time', '_stop'], nrows=70000)
# df_T_gen = pd.read_csv(PARENT_DATA_DIR+r"\BFH_Tiergarten_Ost_1PVS_1min\measurements\01_02_Tiergarten_Ost_T_gen_2004.csv",
#                        skiprows=3, parse_dates=['_start', '_time', '_stop'], nrows=70000)
# df_T_ref = pd.read_csv(PARENT_DATA_DIR+r"\BFH_Tiergarten_Ost_1PVS_1min\measurements\01_02_Tiergarten_Ost_T_ref_2004.csv",
#                        skiprows=3, parse_dates=['_start', '_time', '_stop'], nrows=70000)
# df_U_dc = pd.read_csv(PARENT_DATA_DIR+r"\BFH_Tiergarten_Ost_1PVS_1min\measurements\01_02_Tiergarten_Ost_U_dc+_2004.csv",
#                       skiprows=3, parse_dates=['_start', '_time', '_stop'], nrows=70000)
